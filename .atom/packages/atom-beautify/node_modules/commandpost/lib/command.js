...
var Command = (function () {
    ...
    Command.prototype._parseOptions = function (args) {
        ...
        this.options
            ...
            var optName = utils.kebabToLowerCamelCase(opt.name());
            if (opt.required || opt.optional) {
                // string[]
                _this.parsedOpts[optName] = _this.parsedOpts[optName] || [];
                if (opt.defaultValue) {
                    _this.parsedOpts[optName].push(opt.defaultValue);
                }
            }
            else {
                _this.parsedOpts[optName] = opt.defaultValue;
            }
        });
        return rest;
    };
