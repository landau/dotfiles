...
class CustomTag extends HtmlElement {
    ...
    generateCode(codegen) {
        ...
        if (bodyOnlyIf && renderBodyFunctionVar) {
            let ifStatement = builder.ifStatement(bodyOnlyIf, [builder.functionCall(renderBodyFunctionVarIdentifier, [builder.identifierOut()])], builder.elseStatement([finalNode]));
