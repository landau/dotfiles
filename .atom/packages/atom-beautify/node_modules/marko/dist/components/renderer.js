...
var isServer = componentsUtil._Y_ === true;
...
function handleBeginAsync(event) {
    ...
    asyncOut.c(parentOut._V_, parentOut._X_, parentOut._W_);
}
...
function createRendererFunc(templateRenderFunc, componentProps, renderingLogic) {
    ...
    var isSplit = componentProps._U_ === true;
    var isImplicitComponent = componentProps.aa_ === true;
    ...
    return function renderer(input, out) {
        ...
        if (component) {
            ...
            if (componentDefFromArgs = out._V_) {
                // console.log('componentArgs:', componentArgs);
                scope = componentDefFromArgs.id;
                out._V_ = null;

                customEvents = out._W_;
                var key = out._X_;
...
createRendererFunc._S_ = resolveComponentKey;
createRendererFunc._T_ = handleBeginAsync;