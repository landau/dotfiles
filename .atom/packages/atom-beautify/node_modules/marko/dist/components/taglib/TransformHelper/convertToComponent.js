...
module.exports = function handleComponentBind(options) {
    ...
    if (rendererModule && rendererModule !== componentModule || !rendererModule && componentModule) {
        componentProps._U_ = isSplit = true;
    }

    if (isImplicitComponent) {
        componentProps.aa_ = true;
    }

    if (componentModule) {

        let componentTypeNode = context.addStaticVar('marko_componentType', generateRegisterComponentCode(componentModule, this, isSplit));
