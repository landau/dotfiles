...
module.exports = function handleComponentBind() {
    ...
    if (componentModule) {
        ...
        componentTypeNode = context.addStaticVar('marko_componentType', generateRegisterComponentCode(componentModule, this, isSplit));
    ...
    if (this.firstBind) {
        ...
        var rendererHelper = isLegacyComponent ? transformHelper.context.helper('rendererLegacy') : transformHelper.context.helper('renderer');
        ...
        this.context.on('beforeGenerateCode:TemplateRoot', function (eventArgs) {
            ...
            eventArgs.node.generateAssignRenderCode = function (eventArgs) {
                ...
                let createRendererArgs = [renderFunctionVar, builder.literal(componentProps)];
                ...
                if (!isSplit && !isLegacyComponent) {
                    nodes.push(builder.assignment(builder.memberExpression(templateVar, builder.identifier('Component')), builder.functionCall(defineComponentHelper, [markoComponentVar, templateRendererMember])));
                }
