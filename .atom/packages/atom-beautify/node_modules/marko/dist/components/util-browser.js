...
function getMarkoPropsFromEl(el) {
    ...
    if (vElement) {
        ...
        if (!virtualProps) {
            ...
            el.af_ = virtualProps = virtualProps ? JSON.parse(virtualProps) : EMPTY_OBJECT;
        }
    }
