...
var morphAttrs = require('../runtime/vdom/VElement').aa_;
...
function compareNodeNames(fromEl, toEl) {
    return fromEl.nodeName === toEl._b_;
}
...
function morphdom(fromNode, toNode, context, onNodeAdded, onBeforeElUpdated, onBeforeNodeDiscarded, onNodeDiscarded, onBeforeElChildrenUpdated) {
    ...
    function morphEl(fromEl, toEl, childrenOnly) {
        ...
        if (nodeName !== 'TEXTAREA') {
            ...
            outer: while (curToNodeChild) {
                toNextSibling = curToNodeChild._c_;
                ...
                while (curFromNodeChild) {
                    ...
                    if (curFromNodeType === curToNodeChild.ac_) {
                        if (curFromNodeType === ELEMENT_NODE) {
                            ...
                            curFromNodeChild.nodeValue = curToNodeChild.ae_;
                        }
                    }
    ...
    } else if (fromNodeType == TEXT_NODE || fromNodeType == COMMENT_NODE) {
        // Text or comment node
        if (toNodeType == fromNodeType) {
            morphedNode.nodeValue = toNode.ae_;
            return morphedNode;
        } else {
