...
VElement.prototype = {
    ...
    e: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.aT_(new VElement(tagName, attrs, key, component, childCount, flags, props));
    ...
    ed: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.aT_(VElement.aV_(tagName, attrs, key, component, childCount, flags, props));
    ...
    al_: function (doc) {
        var namespaceURI = this.bi_;
        var tagName = this.ak_;
...
VElement.aV_ = function (tagName, attrs, key, component, childCount, flags, props) {
...
VElement.ai_ = virtualizeElement;

VElement.aj_ = function (fromEl, vFromEl, toEl) {
