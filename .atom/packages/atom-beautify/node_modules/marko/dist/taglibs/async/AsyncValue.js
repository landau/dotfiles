...
AsyncValue.prototype = {
     ...
     * available.
     */
    bu_: function (callback) {

        // Do we already have data or error?
        if (this.bt_) {
            // invoke the callback immediately
            return callback(this.br_, this.au_);
        }

        var callbacks = this.bs_ || (this.bs_ = []);
    ...
    bw_: function (value) {
        ...
        if (value && typeof value.then === 'function') {
            ...
            var finalPromise = value.then(function onFulfilled(value) {
                nextTick(asyncValue.bw_.bind(asyncValue, value));
            }, function onRejected(err) {
                nextTick(asyncValue.bv_.bind(asyncValue, err));
            });
