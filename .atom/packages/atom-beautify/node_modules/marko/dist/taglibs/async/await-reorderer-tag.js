    ...
    out.onLast(function (next) {
        ...
        function handleAwait(awaitInfo) {
            awaitInfo.asyncValue.done(function (err, html) {
                ...
                asyncOut.write('<div id="af' + awaitInfo.id + '" style="display:none">' + html + '</div>' + '<script type="text/javascript">$af(' + (typeof awaitInfo.id === 'number' ? awaitInfo.id : '"' + awaitInfo.id + '"') + (awaitInfo.after ? ',"' + awaitInfo.after + '"' : '') + ')</script>');
