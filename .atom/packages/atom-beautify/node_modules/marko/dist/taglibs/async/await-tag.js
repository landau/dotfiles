...
function requestData(provider, args, thisObj, timeout) {
    ...
    if (typeof provider === 'function') {
        ...
        if (value !== undefined) {
            asyncValue.bw_(value);
        }
    } else {
        // Assume the provider is a data object...
        asyncValue.bw_(provider);
    }
    ...
    if (timeout > 0) {
        let timeoutId = setTimeout(function () {
            ...
            asyncValue.bv_(error);
        }, timeout);

        asyncValue.bu_(function (err, data) {
            if (timeoutId != null) {
...
module.exports = function awaitTag(input, out) {
    ...
    if (clientReorder) {
        ...
        clientReorderContext = out.global.bx_ || (out.global.bx_ = {
            instances: [],
            nextId: 0
        });
