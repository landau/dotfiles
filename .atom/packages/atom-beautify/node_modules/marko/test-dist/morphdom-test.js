...
describe('morphdom', function () {
    ...
    autotest.scanDir(autoTestDir, function run(dir, helpers, done) {
        ...
        var targetVEl = require('marko/runtime/vdom/vdom').ba_(toNode);
        var expectedHTML = serializeNode(toNode);
        fs.writeFileSync(path.join(dir, 'expected.html'), expectedHTML, { encoding: 'utf8' });

        var morphedNode = morphdom(fromNode, targetVEl, {}, function onNodeAdded() {}, function onBeforeElUpdated(node) {
