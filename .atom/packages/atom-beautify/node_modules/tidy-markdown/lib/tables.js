...
var _, extractColumns, extractRows, formatHeaderSeparator, formatRow, getAttribute, getCellAlignment, getColumnWidths, joinColumns, longestStringInArray, nodeType, pad, ref;

_ = require('lodash');

pad = require('pad');

ref = require('./utils'), getAttribute = ref.getAttribute, nodeType = ref.nodeType;
